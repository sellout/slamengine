      ...
      def mergeSrcs(
        ...
        (p1, p2) match {
          case (Map(_, m1), Map(_, m2)) => {
            val lf =
              Free.roll(ProjectField[IT, FreeMap[IT]](UnitF, Free.roll[MapFunc[IT, ?], Unit](StrLit[IT, FreeMap[IT]]("tmp1"))))
            val rf =
              Free.roll(ProjectField[IT, FreeMap[IT]](UnitF, Free.roll[MapFunc[IT, ?], Unit](StrLit[IT, FreeMap[IT]]("tmp2"))))
